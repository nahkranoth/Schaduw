...
import LightPipeLine from './lightingPipeline'
...
export default class Main extends Phaser.Scene{
    ...
    preload(){
        ...
        this.lightingPipeline = this.textures.game.renderer.addPipeline('CustomLight', new LightPipeLine(this.textures.game));
    ...
    create(){
        ...
        this.player = this.physics.add.sprite(180, 370, 'player_sprite').setBounce(0.1);
